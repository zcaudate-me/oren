...
^{:refer oren.core/to-data :added "0.1"}
(fact "converts the object to a map provided *raw* is false")

^{:refer oren.core/all :added "0.1"}
...
^{:refer oren.core/computer-system :added "0.1"}
...
^{:refer oren.core/displays :added "0.1"}
...
^{:refer oren.core/memory :added "0.1"}
...
^{:refer oren.core/network-ifs :added "0.1"}
...
^{:refer oren.core/power :added "0.1"}
...
^{:refer oren.core/sensors :added "0.1"}
...
^{:refer oren.core/process-id :added "0.1"}
...
^{:refer oren.core/process :added "0.1"}
...
^{:refer oren.core/list-processes :added "0.1"}
